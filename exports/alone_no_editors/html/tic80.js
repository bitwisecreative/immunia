...
function createWasm() {
    ...
    function receiveInstance(instance, module) {
        ...
        wasmMemory = wasmExports["Ze"];
        updateMemoryViews();
        wasmTable = wasmExports["af"];
        addOnInit(wasmExports["_e"]);
...
var ASM_CONSTS = {
    ...
    143795: ($0, $1, $2, $3, $4) => {
        ...
        FS.createPreloadedFile(dir, PATH.basename(file), UTF8ToString($3), true, true, function() {
    ...
    152615: () => window.innerWidth,
    152645: () => window.innerHeight
};
...
var wasmImports = {
    ...
    Cb: __emscripten_get_now_is_monotonic,
    sb: __emscripten_throw_longjmp,
    x: _abort,
    Ye: _eglBindAPI,
    Da: _eglChooseConfig,
    Pe: _eglCreateContext,
    Re: _eglCreateWindowSurface,
    Qe: _eglDestroyContext,
    Se: _eglDestroySurface,
    Ea: _eglGetConfigAttrib,
    ya: _eglGetDisplay,
    Oe: _eglGetError,
    Ba: _eglInitialize,
    Te: _eglMakeCurrent,
    ...
    Rc: _emscripten_glGetUniformLocation,
    Tc: _emscripten_glGetUniformfv,
    Sc: _emscripten_glGetUniformiv,
    ...
    vc: _emscripten_glShaderBinary,
    uc: _emscripten_glShaderSource,
    tc: _emscripten_glStencilFunc,
    sc: _emscripten_glStencilFuncSeparate,
    rc: _emscripten_glStencilMask,
    qc: _emscripten_glStencilMaskSeparate,
    pc: _emscripten_glStencilOp,
    oc: _emscripten_glStencilOpSeparate,
    ...
    dc: _emscripten_glUniform2f,
    cc: _emscripten_glUniform2fv,
    bc: _emscripten_glUniform2i,
    ac: _emscripten_glUniform2iv,
    $b: _emscripten_glUniform3f,
    _b: _emscripten_glUniform3fv,
    Zb: _emscripten_glUniform3i,
    ...
    w: _emscripten_has_asyncify,
    Db: _emscripten_memcpy_js,
    Je: _emscripten_request_fullscreen_strategy,
    wa: _emscripten_request_pointerlock,
    tb: _emscripten_resize_heap,
    O: _emscripten_sample_gamepad_data,
    ba: _emscripten_set_beforeunload_callback_on_thread,
    na: _emscripten_set_blur_callback_on_thread,
    ...
    Ib: _emscripten_set_main_loop_timing,
    ta: _emscripten_set_mousedown_callback_on_thread,
    ra: _emscripten_set_mouseenter_callback_on_thread,
    qa: _emscripten_set_mouseleave_callback_on_thread,
    ua: _emscripten_set_mousemove_callback_on_thread,
    sa: _emscripten_set_mouseup_callback_on_thread,
    ia: _emscripten_set_pointerlockchange_callback_on_thread,
    da: _emscripten_set_resize_callback_on_thread,
    ja: _emscripten_set_touchcancel_callback_on_thread,
    la: _emscripten_set_touchend_callback_on_thread,
    ka: _emscripten_set_touchmove_callback_on_thread,
    ma: _emscripten_set_touchstart_callback_on_thread,
    ca: _emscripten_set_visibilitychange_callback_on_thread,
    pa: _emscripten_set_wheel_callback_on_thread,
    Ke: _emscripten_set_window_title,
    v: _emscripten_sleep,
    wb: _environ_get,
    xb: _environ_sizes_get,
    n: _exit,
    _: _fd_close,
    zb: _fd_read,
    rb: _fd_seek,
    ...
    S: _glActiveTexture,
    cb: _glAttachShader,
    gb: _glBindAttribLocation,
    d: _glBindBuffer,
    u: _glBindFramebuffer,
    jd: _glBindRenderbuffer,
    t: _glBindTexture,
    Ka: _glBlendEquation,
    Ja: _glBlendEquationSeparate,
    Q: _glBlendFunc,
    La: _glBlendFuncSeparate,
    c: _glBufferData,
    ...
    Pc: _glFramebufferRenderbuffer,
    X: _glFramebufferTexture2D,
    I: _glGenBuffers,
    Z: _glGenFramebuffers,
    ud: _glGenRenderbuffers,
    Ia: _glGenTextures,
    pb: _glGenerateMipmap,
    ab: _glGetAttribLocation,
    _a: _glGetIntegerv,
    db: _glGetProgramInfoLog,
    eb: _glGetProgramiv,
    ib: _glGetShaderInfoLog,
    jb: _glGetShaderiv,
    B: _glGetString,
    nb: _glGetTexParameteriv,
    ...
    Pa: _glUniform4fv,
    Va: _glUniform4iv,
    Oa: _glUniformMatrix2fv,
    Na: _glUniformMatrix3fv,
...
var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["_e"])();
var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["$e"])(a0, a1);
var _free = a0 => (_free = wasmExports["free"])(a0);
var _malloc = a0 => (_malloc = wasmExports["bf"])(a0);
var ___errno_location = () => (___errno_location = wasmExports["cf"])();
var setTempRet0 = a0 => (setTempRet0 = wasmExports["df"])(a0);
var _setThrew = (a0, a1) => (_setThrew = wasmExports["ef"])(a0, a1);
var stackSave = () => (stackSave = wasmExports["ff"])();
var stackRestore = a0 => (stackRestore = wasmExports["gf"])(a0);
var stackAlloc = a0 => (stackAlloc = wasmExports["hf"])(a0);
var ___cxa_free_exception = a0 => (___cxa_free_exception = wasmExports["__cxa_free_exception"])(a0);
var ___cxa_increment_exception_refcount = a0 => (___cxa_increment_exception_refcount = wasmExports["jf"])(a0);
...
var ___cxa_can_catch = (a0, a1, a2) => (___cxa_can_catch = wasmExports["kf"])(a0, a1, a2);
var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports["lf"])(a0);
var dynCall_ji = Module["dynCall_ji"] = (a0, a1) => (dynCall_ji = Module["dynCall_ji"] = wasmExports["mf"])(a0, a1);
var dynCall_jiji = Module["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module["dynCall_jiji"] = wasmExports["nf"])(a0, a1, a2, a3, a4);
